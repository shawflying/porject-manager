...
app.use(bodyParser.json());//必须的 //body-parser 解析json格式数据 {"data":{"name":"张三","age":25}}  req.body.data.name (获取到张三)
...
require(path.join(__dirname, 'util', 'socket')).listen(server);